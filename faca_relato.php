...
<html lang="en">
<head>
	<title>Para Elas - Faça seu relato</title>
	<meta charset="UTF-8">
	...
	<div class="limiter">
		<div class="container-login100" style="background-color: #fff;">
          ...
          <div class="alert alert-light" role="alert">
            <strong>Olá <?php echo $nomeUser;  ?>!</strong> Aqui nessa aba você poderá deixar seus relatos vivenciados sobre algum tipo de violência já sofrida. Não se preocupe, aqui você pode escolher um nome fantasia caso se sinta mais confortável!
