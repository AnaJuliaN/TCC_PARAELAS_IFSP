        ...
        <div class="container">
            <div class="row">
              ...
              <div class="alert alert-dark" role="alert">
                <strong>Olá <?php echo $nomeUser;  ?>!</strong> Aqui nessa aba você poderá ler relatos feitos por outros usuários, além de também poder fazer um comentário sobre e ver comentários de outras pessoas.<br />
                  Talvez ainda não tenha relatos cadastrados, ou ainda não foram validados pelo Administradores. Caso isso aconteça volte mais tarde, iremos providenciar o mais rápido possível!
