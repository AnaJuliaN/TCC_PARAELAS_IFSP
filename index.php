    ...
    <div class="container" id="nav-container">
      ...
      <nav class="navbar navbar-expand-lg fixed-top navbar-dark">
        <a class="navbar-brand" href="index.php">
          <img id="logo" src="img/logotipo.png" alt="Para elas"><span id="funciona"> Para Elas </span>
        </a>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbar-links">
          <div class="navbar-nav">
            ...
            <a class="nav-item nav-link" id="login-menu" href="cadastrar.php"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
       ...
       <div id="call-area">
        <div class="container">
            <div class="row">
              ...
              <button class="main-btn" id="call-btn"><a href="https://www.delegaciaeletronica.policiacivil.sp.gov.br/ssp-de-cidadao/home">Denunciar</a></button>
            </div>
          </div>
      </div>
    </div>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-12" id="filter-btn-box">
              ...
              <button class="main-btn" id="call-btn" a href="https://www.escoladevoce.com.br/">Escola de você</a></button>
              <button class="main-btn" id="call-btn" a href="https://www.redeasta.com.br/">Rede ASTA</a></button>
