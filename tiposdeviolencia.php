        ...
        <div class="container">
            <div class="row">
              ...
              <div class="alert alert-dark" role="alert">
                <strong>Olá <?php echo $nomeUser;  ?>!</strong> Aqui nessa aba você poderá ler e conhecer sobre os tipos de violências existentes que são comentidos contra as mulheres.
